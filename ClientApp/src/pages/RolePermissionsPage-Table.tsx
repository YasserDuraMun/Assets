      ...
      <div style={styles.container}>
        ...
        {loading && selectedRoleId ? (
          ...
          <div style={styles.permissionsContainer}>
            ...
            <div style={{padding: '32px'}}>
              ...
              <div style={{
                ...
                >
                  <span style={{fontSize: '16px'}}><CheckCircleOutlined /></span>
                  <span>تفعيل جميع الصلاحيات</span>
                </button>
                ...
                >
                  <span style={{fontSize: '16px'}}><CloseCircleOutlined /></span>
                ...
                >
                  <span style={{fontSize: '16px'}}><EyeOutlined /></span>
            ...
            <div style={styles.infoBox}>
              <h4 style={{fontSize: '16px', fontWeight: '600', color: '#1e40af', margin: '0 0 12px 0'}}>
                <AppstoreOutlined /> إدارة الصلاحيات عبر الجدول:
              </h4>
              <div style={{fontSize: '13px', color: '#1e3a8a', lineHeight: '1.6'}}>
                <p style={{margin: '0 0 8px 0'}}>
                  <strong><WarningOutlined /> تنبيه:</strong> جميع التغييرات ستُطبق على المستخدمين الذين لديهم دور <strong>{rolePermissions.roleName}</strong>.
                </p>
                ...
                <p style={{margin: '12px 0 0 0', padding: '12px', backgroundColor: 'rgba(59, 130, 246, 0.1)', borderRadius: '8px', border: '1px solid rgba(59, 130, 246, 0.2)'}}>
                  <strong><AppstoreOutlined /> كيفية الاستخدام:</strong> ببساطة انقر علمفاتيح التبديل في الجدول لتفعيل/تعطيل الصلاحيات. استخدم أزرار الإجراء السريع للعمليات المجمعة. لا تنسَ <strong>حفظ الصلاحيات</strong> عند الانتهاء!
                </p>
              </div>
            </div>
          </div>
          ...
          <div style={{
            ...
            <p style={{color: '#6b7280'}}>اختر دوراً من القائمة المنسدلة أعلاه لعرض وتعديل صلاحياته في واجهة الجدول الجميلة.</p>
          </div>
        )}
      </div>
    </MainLayout>
