...
namespace Assets.Migrations
{
    ...
    [Migration("20260525061850_AddAssetNameEntity")]
    partial class AddAssetNameEntity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Assets.Models.AssetName", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Assets.Models.Asset", b =>
                {
                    b.HasOne("Assets.Models.AssetName", "AssetNameRef")
                        .WithMany("Assets")
                        .HasForeignKey("AssetNameId")
            ...
            modelBuilder.Entity("Assets.Models.AssetDisposal", b =>
                {
                    ...
                    b.HasOne("Assets.Models.Security.User", "PerformedByUser")
                        .WithMany("PerformedDisposals")
            ...
            modelBuilder.Entity("Assets.Models.AssetMaintenance", b =>
                {
                    ...
                    b.HasOne("Assets.Models.Security.User", "Creator")
            ...
            modelBuilder.Entity("Assets.Models.Security.User", b =>
                {
                    ...
                    b.Navigation("PerformedDisposals");
