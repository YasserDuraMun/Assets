        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AssetSubCategories_AssetCategories_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PurchaseOrders_Users_CreatorId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentLocationType = table.Column<int>(type: "int", nullable: false),
                    ...
                    LifespanEndDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Assets_AssetSubCategories_SubCategoryId",
                        column: x => x.SubCategoryId,
                        principalTable: "AssetSubCategories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Assets_Departments_CurrentDepartmentId",
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Assets_Users_UpdaterId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DisposalReason = table.Column<int>(type: "int", nullable: false),
                    ...
                    DisposalDocumentPath = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WarrantyUsed = table.Column<bool>(type: "bit", nullable: false),
                    Notes = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedBy = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorId = table.Column<int>(type: "int", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AssetMovements_Employees_FromEmployeeId",
                        column: x => x.FromEmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AssetMovements_Employees_ToEmployeeId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AssetMovements_Warehouses_FromWarehouseId",
                        column: x => x.FromWarehouseId,
                        principalTable: "Warehouses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AssetMovements_Warehouses_ToWarehouseId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PurchaseOrderItems_Assets_AssetId",
                        column: x => x.AssetId,
                        principalTable: "Assets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "NEW", "#28a745", true, "????" },
                    { 2, "GOOD", "#17a2b8", true, "???" },
                    { 3, "NEEDS_MAINTENANCE", "#ffc107", true, "????? ?????" },
                    { 4, "DAMAGED", "#dc3545", true, "????" },
                    { 5, "FOR_DISPOSAL", "#6c757d", true, "???????" },
                    { 6, "DISPOSED", "#343a40", true, "????" }
                });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "CreatedAt", "Email", "FullName", "IsActive", "LastLoginAt", "PasswordHash", "Role", "Username" },
                values: new object[] { 1, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "admin@dura.ps", "???? ??????", true, null, "$2a$11$7bXZ9h5F2g.xQK4kK4X8m.H0XU9vYZKZH5k5P5M5N5O5Q5R5S5T5U", 1, "admin" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AssetMovements_FromEmployeeId",
                table: "AssetMovements",
                column: "FromEmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_AssetMovements_FromWarehouseId",
                table: "AssetMovements",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AssetMovements_ToEmployeeId",
                table: "AssetMovements",
                column: "ToEmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_AssetMovements_ToWarehouseId",
                table: "AssetMovements",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Assets_CurrentDepartmentId",
                table: "Assets",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Assets_UpdaterId",
                table: "Assets",
                column: "UpdaterId");

            migrationBuilder.CreateIndex(
                name: "IX_AssetSubCategories_CategoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchaseOrderItems_AssetId",
